...
After that you need to add existing the users so that they can log in and for that, you need to enable **Email/Password** authentication in your project's Authentication section, for that, you need to click on the tab `Authentication` on the top left `Develop` section.
